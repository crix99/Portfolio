...
function scrollHeader() {
    ...
    // When the scroll > 80 viewport height, add the scroll-header class to header tag
    if(this.scrollY >= 80)
...
function scrollUp() {
    ...
    // When the scroll > 560 viewport height, add the show-scroll class to the a tag
    if(this.scrollY >= 560) 
...
themeButton.addEventListener('click', () => {
    ...
    // Save the theme and the current icon that use chose
